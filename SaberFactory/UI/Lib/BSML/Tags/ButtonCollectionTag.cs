...
namespace SaberFactory.UI.Lib.BSML.Tags
{
    ...
    {
        public override string[] Aliases => new[] { "sui.button-collection" };
        ...
        public override GameObject CreateObject(Transform parent)
        {
            ...
            foreach (Transform transform in textSegmentedControl.transform) Object.Destroy(transform.gameObject);
